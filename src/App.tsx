...
import PreCurrenciesList from './features/currencies/PreCurrenciesList';
import CurrenciesList from './features/currencies/CurrenciesList';
import PrefetchCurrencies from './features/currencies/PrefetchCurrencies';
import UserOptions from './features/users/UserOptions';
import MyOrders from './pages/MyOrders';
import MyCart from './pages/MyCart';
import ProductsListAll from './features/products/ProductsListAll';
      ...
      <Route path='/' element={<Layout />}>
        ...
        <Route element={<PersistLogin />}>
          <Route element={<RequireAuth allowedRoles={[...Object.values(ROLES)]} />}>
            <Route element={<UserOptions />}>
              <Route element={<Prefetch />}>
                <Route element={<PrefetchCurrencies />}>
                  ...
                  <Route path='cart/my' element={<MyCart />} />
                  ...
                  <Route element={<RequireAuth allowedRoles={[ROLES.Manager, ROLES.Admin]} />}>
                    <Route path="dash" element={<DashLayout />}>
                      ...
                      <Route path="products">
                        ...
                        <Route path="all" element={<ProductsListAll />} />
                      ...
                      <Route path="currencies">
                        <Route index element={<PreCurrenciesList />} />
                        <Route path="value" element={<CurrenciesList />} />
